...
*********************************************************************************/
using WisdomLogistics.Application.SystemSecurity;
using WisdomLogistics.Code;
using WisdomLogistics.Domain.Entity.SystemSecurity;
using System.Web.Mvc;

namespace WisdomLogistics.Web.Areas.SystemSecurity.Controllers
{
    public class DbBackupController : ControllerBase
    {
        ...
        public ActionResult SubmitForm(DbBackupEntity dbBackupEntity)
        {
            ...
            dbBackupEntity.F_FilePath = @"\Resource/DbBackup\" + dbBackupEntity.F_FileName + ".bak";//Request.ApplicationPath+
